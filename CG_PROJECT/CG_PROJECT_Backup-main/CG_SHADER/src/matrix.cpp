...
glm::mat4 matrix::GetProjection()
{
	...
	projection = glm::perspective(glm::radians(50.0f), screenWidth/ screenHeight, 0.1f, 1000.0f); //--- 투영 공간 설정: fovy, aspect, near, far
...
{
	glm::mat4 projection = glm::mat4(1.0f);
	projection = glm::ortho(-100.0f, 100.0f, -100.0f, 100.0f, -300.0f, 300.0f);
